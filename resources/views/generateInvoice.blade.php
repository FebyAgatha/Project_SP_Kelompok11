    ...
    <table>
        ...
        <tbody>
            ...
            @foreach($carts as $details)
                ...
                @php
                    $totalAmount += $details->product->price * $details->quantity;
                @endphp
            @endforeach            
            <tr>
                <td colspan="3" class="total-heading">Total Amount - <small>Inc. all vat/tax</small> :</td>
                <td colspan="1" class="total-heading">Rp {{ number_format($totalAmount, 2) }}</td>
            </tr>
        </tbody>
    </table>
