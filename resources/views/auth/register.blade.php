<x-guest-layout>
    <x-authentication-card>
        <h1 class="my-3 text-3xl font-black text-center">REGISTER</h1>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="postalcode" class="block mt-1 w-full" type="text" name="postalcode" required autocomplete=off/>
                @error('postalcode')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
